...
description: Install Mystic Essentials, generate configuration, and verify the server is ready.
---
...
```text
build/libs/MysticEssentials-1.0.0.jar
```

For the project-local test server:

```bash
./gradlew deployMod
```

The Gradle build uses a JDK 25 toolchain.
