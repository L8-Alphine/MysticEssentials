---
title: Mystic Essentials
description: End-user, server owner, and developer documentation for the Mystic Essentials Hytale server mod.
---
...
Players should start with the [Player Guide](player-guide.md). It explains the commands and UI flows they will use most often.

Server owners and staff should start with [Getting Started](getting-started.md), then read [Admin Guide](admin-guide.md), [Configuration Reference](configuration.md), [Permissions Reference](permissions.md), and [Integrations and Storage](integrations-and-storage.md).
...
- [Install the mod](getting-started.md)
- [All player commands](commands.md)
- [All permission nodes](permissions.md)
- [Migrate from other essentials mods](migration-guide.md)
- [Configure storage, Redis, and integrations](integrations-and-storage.md)
- [Customize chat colors, gradients, placeholders, and links](chat-formatting.md)
- [Build addons with the public API](developer-api.md)
